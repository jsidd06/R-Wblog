...
const homeStartingContent = "Here you can upload Daily good thoughts, nature thoughts, education thoughts, and all knowledgeable post you can write here otherwise your blog post we will be deleted up to 12 hours so don't wrong content and make your good post readable and if you don't dare to write a post don't write is optional you can skip read-only fun blog post thank you. ";
const aboutContent = "Hello, guys Welcome to Read & write a blog post. I have done this project for public use to a writing blog and made an interested a new repository and Read a daily update blog in R&W. Thanks for visited 😎 This is my Instagram profile sidd.jain.90 follow me.";
...
//conneting mongoose
mongoose.connect('mongodb+srv://siddharth:jsidd06@cluster0.8op7l.mongodb.net/postDB', {
